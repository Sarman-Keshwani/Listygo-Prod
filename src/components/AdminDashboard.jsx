        ...
        try {
          ...
          const countPromises = categoriesData.map(async (category) => {
            try {
              ...
              console.error(
                `Error fetching count for category ${category.name}:`,
                err
              );
  ...
  const userColumns = [
    {
      ...
      render: (text, record) => (
        <div className="flex items-center">
          <Avatar src={record.profilePicture} className="mr-2 bg-blue-100">
      ...
      render: (name, record) => (
        <div className="flex items-center space-x-3">
          ...
          <Tooltip title={name}>
            ...
            >
              {isMobile && name.length > 12
                ? name.substring(0, 12) + "..."
                : isTablet && name.length > 20
                ? name.substring(0, 20) + "..."
                : name}
            </span>
          </Tooltip>
      ...
      {showLayoutEditor && (
        ...
        >
          <Card className="shadow-lg border-blue-100">
            <LayoutEditor boxData={layoutData} onUpdate={fetchLayoutData} />
          </Card>
        </motion.div>
      )}
          ...
          {categoriesLoading ? (
                ...
                .map((category) => (
                  ...
                  >
                    <Card
                      ...
                      onClick={() =>
                        navigate(`/admin/listings?category=${category._id}`)
                      }
                      size="small"
                      bodyStyle={{
                    ...
                    >
                      <div className="flex flex-col items-center py-1">
                        <div
                          className={`w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center mb-2 sm:mb-3 shadow-md`}
                        >
              ...
              >
                ...
                >
                  <div className="flex flex-col items-center justify-center h-full py-2 sm:py-4">
                    <div
                      className={`w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 flex items-center justify-center mb-2 sm:mb-3 shadow-md`}
                    >
                      <FiPlus
            ...
            <div className="py-8 text-center">
              <Empty
                ...
                image={Empty.PRESENTED_IMAGE_SIMPLE}
              />
              <Button onClick={() => handleCategorySearch("")} className="mt-4">
                Clear Search
              </Button>
            </div>
          ) : (
                ...
                description={
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mb-4">
                      Categories help organize your listings
                    </p>
                  </div>
                }
                image={Empty.PRESENTED_IMAGE_SIMPLE}
          ...
          extra={
            <div
              className={`flex flex-col ${
                isMobile ? "space-y-2" : "sm:flex-row sm:space-x-2"
              } mb-4 sm:mb-0`}
            >
              <Button
                icon={<FiRefreshCw />}
              ...
              <Select
                ...
                onChange={(value) => {
                  ...
                  if (value) {
                    const filtered = recentListings.filter(
                      (item) =>
                  ...
                  description={
                    <div>
                      ...
                      <p className="text-sm text-gray-400 mb-4">
                        {listingsLoading
                          ? "Loading listings..."
                          : "Start adding listings to your directory"}
                      </p>
                    </div>
                  }
                  image={Empty.PRESENTED_IMAGE_SIMPLE}
