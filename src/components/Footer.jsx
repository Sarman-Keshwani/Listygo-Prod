  ...
  return (
    <>
      ...
      <footer className="bg-gradient-to-b from-blue-900 to-blue-950 text-white pt-16 relative ">
        ...
        >
          <div className="mb-4  relative md:mb-0 md:mr-4">
            ...
            <p className="text-gray-600">
              Our support team is here to help you find the perfect stay.
            </p>
          </div>
          <Link to="/contact">
            <Button
        ...
        <div className="max-w-6xl mx-auto px-4 py-14 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-10 border-t border-blue-800 pt-20">
          ...
          <div className="flex flex-col items-start mb-8 md:mb-0">
            ...
            <Text className="text-blue-200 mt-2">
              <span className="text-white">
                Find your perfect accommodation worldwide with our premium
                booking platform.
              </span>
            </Text>
            <div className="flex space-x-4 text-xl mt-6">
              <a
                href="#"
                className="w-10 h-10 bg-blue-800 hover:bg-blue-700 text-white flex items-center justify-center rounded-full transition-colors"
              >
                <FaFacebookF size={16} />
              </a>
              <a
            ...
            <ul className="space-y-3">
              <li>
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    showSupportModal("Help Center", supportContent.help);
                  }}
                  className="text-blue-200 hover:text-white transition-colors flex items-center cursor-pointer"
                >
                  <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>
                  Help Center
                </a>
              ...
              <li>
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    showSupportModal("COVID-19 Response", supportContent.covid);
                  }}
                  className="text-blue-200 hover:text-white transition-colors flex items-center cursor-pointer"
                >
                  <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>
              ...
              <li>
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    showSupportModal("FAQs", supportContent.faq);
                  }}
                  className="text-blue-200 hover:text-white transition-colors flex items-center cursor-pointer"
                >
                  <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mr-2"></span>
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-blue-200 mb-4">
              Subscribe to our newsletter for travel inspiration, tips, and
              exclusive offers. Join our community today!
            </p>
        ...
        {/* Closing tag for Main Footer Content div */}
        {/* Bottom Bar */}
      ...
      >
        ...
        {modalContent.title === "Help Center" && <div className="mt-4"></div>}
