  ...
  return (
    ...
    >
      <motion.div variants={itemVariants} className="text-center mb-8">
        <h2 className="text-3xl mr-20 font-bold mb-2 text-gray-800">Sign in</h2>
        <p className="text-gray-600  mr-20">
          Access your account to manage bookings and preferences
        </p>
      </motion.div>
      <p className="text-gray-600 mb-5">
        Are you a Vendor? Login in as a Vendor!
      </p>
      <Link
        to="/admin/login"
        className="hover:text-white transition-colors bg-blue-600 w-[130px] px-3 rounded-2xl text-white font-bold mb-10"
      >
        Vendor Login
      </Link>
      <motion.div
