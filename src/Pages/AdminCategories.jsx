    ...
    try {
      ...
      if (error.response) {
        ...
        if (error.response.status === 400) {
          ...
          if (error.response.data && error.response.data.message) {
            ...
            notification.error({
              message: "Error",
              description:
                "The category could not be created. Please check your data.",
            });
          }
        } else {
          notification.error({
        ...
        notification.error({
          ...
          description:
            error.message ||
            "Failed to create category. Network or server issue.",
        });
      }
    }
  };
    ...
    try {
      ...
      if (error.response?.data?.error === "category.remove is not a function") {
        ...
        notification.error({
          ...
          description:
            "The server needs to be updated to use modern MongoDB methods like deleteOne() instead of remove().",
          duration: 8,
        });
        ...
        if (error.response.status === 500) {
          notification.error({
            ...
            description:
              "This category has associated listings. Please remove all listings in this category before deleting it.",
            duration: 6,
          });
        ...
        <Space>
          ...
          <Popconfirm
            ...
            description={
              <div>
                <p>
                  This action will completely remove the category from the
                  database.
                </p>
                ...
                <p className="text-red-500">
                  Note: Categories with associated listings cannot be deleted.
                </p>
              </div>
            }
          ...
          >
            <Button type="primary" danger size="small" icon={<FiTrash2 />}>
              Delete
            </Button>
          </Popconfirm>
          <Button
      ...
      <div className="container mx-auto p-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
          <div>
            ...
            <p className="text-gray-600">
              Create, update and delete categories for listings
            </p>
          </div>
        ...
        <Card className="shadow-md">
          {loading ? (
            ...
            <Empty description="No categories found" className="py-16" />
          )}
        </Card>
      </div>
      <Modal
